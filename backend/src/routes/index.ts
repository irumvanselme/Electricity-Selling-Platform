...
import { createAProduct, getProductsHandler } from "./products";
...
export default function routes (app: Express) {
    ...
    app.get("/api/products", (req, res) => getProductsHandler(req, res));

    app.post("/api/products", (req, res) => createAProduct(req, res))
